    ...
    public static Message FromBytes(byte[] message) {
        ...
        return protocolType switch {
            ProtocolType.AdjacentInterlockingSystem => messageType switch {
                ...
                0x0016 => AdjacentInterlockingSystemAbortRouteCancellationRequestCommand.FromBytes(message),
            ...
            ProtocolType.Point => messageType switch {
                ...
                0x000C => PointMovementFailedMessage.FromBytes(message),
            ...
            ProtocolType.GenericIO => messageType switch {
                0x0001 => GenericIOSetOutputChannelsCommand.FromBytes(message),
